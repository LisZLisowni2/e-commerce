...
docker build -t 127.0.0.1:5000/ecommerce-frontend-dev:latest "$PROJECT_DIR/frontend" -f "$PROJECT_DIR/frontend/Dockerfile.dev"
docker build -t 127.0.0.1:5000/ecommerce-backend:latest "$PROJECT_DIR/backend"
docker push 127.0.0.1:5000/ecommerce-frontend-dev:latest
